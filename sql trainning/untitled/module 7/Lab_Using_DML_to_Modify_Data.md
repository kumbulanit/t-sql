...
IF EXISTS(SELECT * FROM sys.databases WHERE name = 'DMLLab')
    DROP DATABASE DMLLab;
GO

CREATE DATABASE DMLLab;
GO
...
### Task 1.1: Design and Populate a Complete E-commerce System
```sql
-- TODO: Create the following tables with appropriate data types and constraints:

-- 1. Customers table with automatic ID generation and audit fields
-- Requirements:
